...
namespace Ordering.Application.Extensions
{
    public static class OrderExtensions
    {
        public static IEnumerable<OrderDTO> ToOrderDTOList(this IEnumerable<Order> orders, IEnumerable<OrderItem> orderItems)
        {
            ...
            {
                var filteredOrderItems = orderItems.Where(oi => oi.OrderId.Value == order.Id.Value);
                ...
                return new OrderDTO(
                    ...
                    Status: order.Status,
                    OrderItems: filteredOrderItems.Select(oi => new OrderItemDTO(oi.OrderId.Value, oi.ProductId.Value, oi.Quantity, oi.Price)).ToList());
            });
        }
